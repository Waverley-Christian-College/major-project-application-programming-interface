...
for entry in data:
    ...
    total_highs_plus_lows += highs_plus_lows #Changing the Variable of total_highs_plus_lows by adding the values of highs_plus_loes together
...
for entry in data:
    ...
    total_volatility_prices += volatility_price
